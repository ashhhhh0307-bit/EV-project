  ...
  return (
    <div className={`route-login-page ${ready ? "is-ready" : ""}`}>
      ...
      <section className="route-stage"><div className="route-card">
        ...
        {step === "help" && <AccessStep eyebrow="Request Help" title="List or browse replacement EVs" sub="Open the linked Volt Route owner workspace to list an EV, set your availability, and browse vehicles available for replacement mobility." icon={<LockKeyhole size={21} />} action="Open EV owner listing" onAction={() => { window.localStorage.setItem("autoswap_open_owner_listing", "1"); startLogin(); }} />}
