  ...
  return (
    <div className={`route-login-page ${ready ? "is-ready" : ""}`}>
      ...
      <section className="route-stage"><div className="route-card">
        ...
        {step === "help" && <AccessStep eyebrow="Request Help" title="See replacement requests" sub="Sign in securely to review every repair-period detail, accept an available vehicle offer, and start the active rental handoff." icon={<LockKeyhole size={21} />} action="Open replacement requests" onAction={() => { window.localStorage.setItem("autoswap_post_login_page", "requests"); startLogin(); }} />}
